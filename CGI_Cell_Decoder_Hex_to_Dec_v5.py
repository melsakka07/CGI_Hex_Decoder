...
# Add input fields
ttk.Label(root, text="Enter 4G CGI in hex:").grid(row=1, column=0, padx=10, pady=5, sticky="e")
entry_4g = ttk.Entry(root, width=30)
entry_4g.grid(row=1, column=1, padx=10, pady=5)

ttk.Label(root, text="Enter 5G CGI in hex:").grid(row=2, column=0, padx=10, pady=5, sticky="e")
entry_5g = ttk.Entry(root, width=30)
entry_5g.grid(row=2, column=1, padx=10, pady=5)
...
result_4g.grid(row=4, column=0, columnspan=2, padx=10, pady=5)

result_5g = tk.Text(root, height=10, width=60)
result_5g.grid(row=5, column=0, columnspan=2, padx=10, pady=5)
